      ...
      <div className="styles_privacyPolicy__M4vnf">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <ul className="list-disc list-inside mb-4 space-y-2">
            ...
            <li>
              <strong>Application</strong> refers to Swapxnext, the software
          ...
          <h3 className="text-2xl font-bold mt-4 mb-2">Personal Data</h3>
          <p className="mb-4">
          ...
          <h3 className="text-2xl font-bold mt-4 mb-2">Usage Data</h3>
          <p className="mb-4">
          ...
          <ul className="list-disc list-inside mb-4 space-y-2">
            <li>
              <strong>Provide and maintain our Service,</strong> including to
            ...
            <li>
              <strong>To manage Your requests:To manage Your requests:</strong>{" "}
          ...
          <h2 className="text-3xl font-bold mt-6 mb-2">
            Rentention of Your Personal Data
          </h2>
          <p className="mb-4">
          ...
          <h3 className="text-2xl font-bold mt-4 mb-2">Law enforcement</h3>
          <p className="mb-4">
          ...
          <h2 className="text-3xl font-bold mt-6 mb-2">Contact Us</h2>
          <p className="mb-4">
