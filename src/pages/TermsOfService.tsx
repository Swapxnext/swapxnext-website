    ...
    <>
      <div className="styles_privacyPolicy__M4vnf">
        <div>
          <div className=" mx-auto px-4">
            <div className="space-y-3">
              ...
              <p className="text-[#301a4b] text-center">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <h1 className="font-bold text-4xl mt-8 mb-4">
            Interpretation and Definitions
          </h1>
          <h2 className="mt-4 font-bold text-3xl mb-2">Interpretation</h2>
          <p className="mb-4">
          ...
          <h2 className="text-3xl font-bold mb-2">Definitions</h2>
          <p className="mb-4">
          ...
          <h1 className="text-4xl font-bold mt-8 mb-4">Acknowledgment</h1>
          <p className="mb-4">
          ...
          <h1 className="text-4xl font-bold mt-8 mb-4">User Accounts</h1>
          <p className="mb-4">
          ...
          <h1 className="text-4xl font-bold mt-8 mb-4">Termination</h1>
          <p className="mb-4">
          ...
          <h1 className="text-4xl font-bold mt-8 mb-4">Governing Law</h1>
          <p className="mb-4">
...
-            States government list of prohibited or restricted parties.
          ...
          <h2 className="text-3xl font-bold mt-6 mb-2">Severability</h2>
          <p className="mb-4">
          ...
          <h2 className="text-3xl font-bold mt-6 mb-2">Waiver</h2>
          <p className="mb-4">
